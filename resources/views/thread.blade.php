...
<body>
    ...
    <div class="row-container">
        ...
        <div class="create-thread">
            <button class="threadbutton" type="button" data-toggle="modal" data-target="#createthread">
                <i class="bi bi-file-text"></i> Create Thread
            </button>
            ...
            <div class="filter-wrapper">
                ...
                @if ($isfiltered == true)
                    <a href="/forum/{{$forum_id}}">
                        <button>
                            <i class="bi bi-question-circle"></i> Unresolved
                        </button>
                    </a>
                    <a href="/forum/{{$forum_id}}">
                        <button>
                    ...
                    <a href="/forum/{{$forum_id}}">
                        <button>
                            <i class="bi bi-exclamation-circle"></i> No Replies
                        </button>
                    </a>
                    <a href="/forum/{{$forum_id}}">
                ...
                @else
                    <a href="../forum/{{$forum_id}}/filter/0">
                        <button>
                            <i class="bi bi-question-circle"></i> Unresolved
                        </button>
                    </a>
                    <a href="../forum/{{$forum_id}}/filter/1">
                        <button>
                            <i class="bi bi-check-circle"></i> Resolved
                        </button>
                    </a>
                    <a href="../forum/{{$forum_id}}/filter/2">
                        <button>
                            <i class="bi bi-exclamation-circle"></i> No Replies
                        </button>
                    </a>
